        ...
        <%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
            ...
            <head>
                <jsp:include page="/views/partials/head.jsp">
                    <jsp:param name="title" value="Kết quả tìm kiếm - Bus Booking System" />
                </jsp:include>
                <style>
                    :root {
                    ...
                    <div class="container search-hero-content">
                        <div class="text-center">
                            ...
                            <p class="search-subtitle">
                                Từ <strong>${departureCity}</strong> đến <strong>${destinationCity}</strong>
                            </p>
                            <div class="date-badges">
                                <c:if test="${not empty departureDate}">
                                    <span class="date-badge">
                                        <i class="fas fa-calendar-alt"></i>
                                        <span>Đi: ${departureDate}</span>
                                    </span>
                                </c:if>
                                <c:if test="${not empty returnDate}">
                                    <span class="date-badge">
                                        <i class="fas fa-calendar-alt"></i>
                                        <span>Về: ${returnDate}</span>
                                    </span>
                                </c:if>
                            </div>
                        </div>
                    ...
                    <c:choose>
                        <c:when test="${empty routes}">
                            <div class="empty-state">
                                ...
                                <h3 class="empty-state-title">Không tìm thấy tuyến đường</h3>
                                <p class="empty-state-text">Xin lỗi, chúng tôi không tìm thấy tuyến đường nào phù hợp với yêu cầu của bạn.</p>
                            </div>
                        </c:when>
                        <c:otherwise>
                            <div class="row g-4">
                                            ...
                                            <div class="route-card-body">
                                                <div class="route-info-grid">
                                                    ...
                                                    <div class="route-info-item">
                                                        ...
                                                        <div class="route-info-value">${route.durationHours} giờ</div>
                                                    </div>
                                                </div>
                                                <div class="route-price">
                                                    <div class="route-price-label">Giá từ</div>
                    ...
                    <c:if test="${tripType eq 'roundtrip'}">
                        <div class="return-routes-section">
                            <div class="section-header">
                                ...
                                <h2 class="section-header-title">Tuyến đường về</h2>
                            </div>
                            <c:choose>
                                <c:when test="${empty returnRoutes}">
                                    <div class="alert alert-info alert-custom">
                                        <i class="fas fa-info-circle me-2"></i>Không tìm thấy tuyến đường về
                                    </div>
                                </c:when>
                                <c:otherwise>
                                    <div class="row g-4">
