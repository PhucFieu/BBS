        ...
        <%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
            ...
            <head>
                ...
                <style>
                    ...
                    .form-control:focus { border-color: #66bb6a; box-shadow: 0 0 0 0.2rem rgba(102, 187, 106, 0.25); }
                    .btn-search { background: linear-gradient(135deg, #66bb6a 0%, #81c784 100%); border: none; padding: 12px 30px; font-weight: 600; }
                    .btn-search:hover { transform: translateY(-2px); box-shadow: 0 5px 15px rgba(102, 187, 106, 0.4); }
                    ...
                    .trip-type-buttons .btn.active { background: linear-gradient(135deg, #66bb6a 0%, #81c784 100%); border-color: #66bb6a; }
                    .feature-icon { font-size: 2rem; color: #66bb6a; margin-bottom: 15px; }
                    ...
                    .route-selection-card:hover { border-color: #66bb6a; box-shadow: 0 4px 8px rgba(102, 187, 106, 0.15); }
                    .route-selection-card.border-primary { border-color: #66bb6a !important; border-width: 2px; }
                </style>
            </head>
                                ...
                                fetch(url)
                                    ...
                                    .then(data => {
                                        ...
                                        if (!data.routes || data.routes.length === 0) {
                                            routesList.innerHTML = '<div class="alert alert-info">No routes found</div>';
                            ...
                            function displayRoutes(routes) {
                                ...
                                routes.forEach(route => {
                                    ...
                                    infoDiv.innerHTML =
                                        ...
                                        '<small><i class="fas fa-clock"></i> ' + route.durationHours + ' hours</small>' +
                                        '<small><i class="fas fa-money-bill text-success"></i> ' + price + '₫</small>' +
                                        '<small><i class="fas fa-calendar"></i> ' + route.scheduleCount + ' schedules</small>';
