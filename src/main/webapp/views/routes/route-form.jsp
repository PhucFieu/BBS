                                ...
                                <form id="routeForm"
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-6">
                                            ...
                                            <select class="form-select" id="departureCityId" name="departureCityId"
                                                ...
                                                <c:forEach var="city" items="${cities}">
                                                    <option value="${city.cityId}" data-city-number="${city.cityNumber}"
                                                        ${route !=null && route.departureCityId==city.cityId
                                                        ? 'selected' : '' }>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select class="form-select" id="destinationCityId" name="destinationCityId"
                                                required>
                                                <option value="">Select destination city</option>
                                                <c:forEach var="city" items="${cities}">
                                                    <option value="${city.cityId}" data-city-number="${city.cityNumber}"
                                                        ${route !=null && route.destinationCityId==city.cityId
                                                        ? 'selected' : '' }>
                                                        ${city.cityNumber}. ${city.cityName}
                                                    </option>
                                                </c:forEach>
                        ...
                        document.addEventListener('DOMContentLoaded', function () {
                            ...
                            function updateIntermediateStations() {
                                ...
                                if (!depCityId || !destCityId) {
                                    stationContainer.innerHTML = '<div class="empty-state">' +
                                        ...
                                        '<p>Vui lòng chọn thành phố đi và thành phố đến</p>' +
                                        '</div>';
                                    return;
                                }
                                ...
                                citiesInRange.forEach(city => {
                                    ...
                                    let cityBadge = '';
                                    if (isDepCity) {
                                        cityBadge = '<span class="terminal-badge departure"><i class="fas fa-play-circle me-1"></i>Điểm đi</span>';
                                    } else if (isDestCity) {
                                        cityBadge = '<span class="terminal-badge destination"><i class="fas fa-flag-checkered me-1"></i>Điểm đến</span>';
                                    }
                                    ...
                                    html += '<div class="city-group">' +
                                        ...
                                        ' <span class="station-count">' + cityStations.length + ' trạm</span>' +
                                        cityBadge +
                                        '</div>';
                                    ...
                                    cityStations.forEach(station => {
                                        ...
                                        if (station.id === departureTerminalStationId) {
                                            stationBadge = '<span class="terminal-badge departure">Điểm xuất phát</span>';
                                        } else if (station.id === destinationTerminalStationId) {
                                            stationBadge = '<span class="terminal-badge destination">Điểm kết thúc</span>';
                                        }
                                ...
                                if (html) {
                                    ...
                                    stationContainer.innerHTML = '<div class="empty-state">' +
                                        ...
                                        '<p>Không tìm thấy trạm nào trong phạm vi đã chọn</p>' +
                                        '</div>';
                                }
                            ...
                            document.querySelector('form').addEventListener('submit', function (e) {
                                if (!departureCitySelect.value || !destinationCitySelect.value) {
                                    alert('Vui lòng chọn thành phố đi và thành phố đến.');
                                    e.preventDefault();
                                    return false;
                                }
                                if (departureCitySelect.value === destinationCitySelect.value) {
                                    alert('Thành phố đi và thành phố đến phải khác nhau.');
                                    e.preventDefault();
                                    return false;
                                }
                                return true;
