        ...
        <%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
            <%@ taglib prefix="fn" uri="http://java.sun.com/jsp/jstl/functions" %>
                ...
                <head>
                    ...
                    <title>${empty roleDisplayName ? 'Passenger' : roleDisplayName} Management - Admin Dashboard</title>
                ...
                <body>
                    ...
                    <c:set var="roleDisplay" value="${empty roleDisplayName ? 'Passenger' : roleDisplayName}" />
                    <c:set var="roleDisplayLower" value="${fn:toLowerCase(roleDisplay)}" />
                    <c:set var="managementPathSafe" value="${empty managementPath ? '/admin/users' : managementPath}" />
                            ...
                            <div class="col-12">
                                ...
                                <div class="search-container">
                                    <div class="row align-items-center">
                                        <div class="col-md-8">
                                            <h2 class="mb-0">
                                                <i class="fas fa-users me-2"></i>${roleDisplay} Management
                                            </h2>
                                            <p class="mb-0 mt-2">Manage ${roleDisplayLower} accounts and information</p>
                                        </div>
                                        <div class="col-md-4 text-md-end mt-3 mt-md-0">
                                            <a href="${pageContext.request.contextPath}${managementPathSafe}/add"
                                                class="btn btn-light btn-lg">
                                                <i class="fas fa-plus-circle me-2"></i>Add New ${roleDisplay}
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="filter-section">
                                        <form action="${pageContext.request.contextPath}${managementPathSafe}"
                                            method="get">
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control border-0" id="search"
                                                            ...
                                                            placeholder="Search ${roleDisplayLower}s...">
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <select class="form-select border-0" id="statusFilter"
                                                        ...
                                                        <option value="ACTIVE" ${param.status eq 'ACTIVE' ? 'selected'
                                                            : '' }>Active</option>
                                                        <option value="INACTIVE" ${param.status eq 'INACTIVE'
                                                ...
                                                <div class="col-md-2">
                                                    <a href="${pageContext.request.contextPath}${managementPathSafe}"
                                ...
                                <c:choose>
                                    <c:when test="${empty users}">
                                        <div class="text-center py-5">
                                            ...
                                            <h4 class="text-muted">No ${roleDisplayLower}s found</h4>
                                                                ...
                                                                <tr class="user-item" data-status="${user.status}">
                                                                    ...
                                                                    <td>
                                                                        <div class="btn-group" role="group">
                                                                            ...
                                                                            <a href="${pageContext.request.contextPath}${managementPathSafe}/edit?id=${user.userId}"
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <p class="text-center mb-3">Are you sure you want to delete ${roleDisplayLower}
                                        <strong id="userNameToDelete" class="text-danger"></strong>?
                                    </p>
                                    <div class="alert alert-warning" role="alert">
                                        <i class="fas fa-exclamation-triangle me-2"></i>
                                        <strong>Warning:</strong> This action cannot be undone. The ${roleDisplayLower}
                                        account will
                                        be
                                ...
                                <div class="modal-footer">
                                    ...
                                    <a href="#" id="confirmDeleteBtn" class="btn btn-danger">
                                        <i class="fas fa-trash me-1"></i>Delete ${roleDisplay}
                                    </a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <div class="d-flex align-items-center mb-2">
                                                <i class="fas fa-check-circle text-success me-3"
                                                    style="width: 20px;"></i>
                                                <div>
                        ...
                        <script>
                            function confirmDelete(userId, el) {
                                ...
                                document.getElementById('confirmDeleteBtn').href =
                                    '${pageContext.request.contextPath}' + '${managementPathSafe}' + '/delete?id=' + userId;
