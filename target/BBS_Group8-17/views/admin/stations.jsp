    ...
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        ...
        <body>
                    ...
                    <div class="col-12">
                        ...
                        <div class="search-container">
                            ...
                            <div class="filter-section">
                                <form action="${pageContext.request.contextPath}/stations/search" method="get">
                                    <div class="row">
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-3">
                                            <input type="text" class="form-control border-0" id="city" name="city"
                                                value="${param.city}" placeholder="City (e.g: Hanoi)">
                                        </div>
                                        <div class="col-md-3">
                        ...
                        <c:choose>
                            <c:when test="${empty stations}">
                                <div class="text-center py-5">
                                    ...
                                    <p class="text-muted">Click "Add New Station" to create your first station</p>
                                </div>
                            </c:when>
                            <c:otherwise>
                                    ...
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            <table class="table table-hover align-middle" id="stationsTable">
                                                ...
                                                <tbody id="stationsContainer">
                                                    <c:forEach var="station" items="${stations}">
                                                        <tr class="station-item" data-status="${station.status}">
                                                            <td>
                                                                <div class="fw-bold">
                                                                    <i
                                                                        class="fas fa-map-marker-alt me-1 text-primary"></i>
                                                                    ${station.stationName}
                                                                </div>
                                                            </td>
                                                            <td>
                                                            ...
                                                            <td>
                                                                <small class="text-muted">
                                                                    <i
                                                                        class="fas fa-location-dot me-1"></i>${station.address}
                                                                </small>
                                                            </td>
                                                            <td>
                                                                <span
                                                                    class="badge status-badge ${station.status eq 'ACTIVE' ? 'bg-success' : 'bg-secondary'}">
                                                                    ${station.status}
                                                                </span>
                                                            </td>
                                                            <td>
                                                                <div class="btn-group" role="group">
                                                                    <button type="button"
                                                                        ...
                                                                        data-bs-target="#stationDetailModal"
                                                                    ...
                                                                    <a href="${pageContext.request.contextPath}/admin/stations/edit?id=${station.stationId}"
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <p class="text-center mb-3">Are you sure you want to delete station <strong
                                    id="stationNameToDelete" class="text-danger"></strong>?</p>
                            <div class="alert alert-warning" role="alert">
                                <i class="fas fa-exclamation-triangle me-2"></i>
                                <strong>Warning:</strong> This action cannot be undone. The station will be
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="d-flex align-items-center mb-2">
                                        <i class="fas fa-city text-info me-3" style="width: 20px;"></i>
                                        <div>
                                ...
                                <div class="col-12 mb-3">
                                    <div class="d-flex align-items-start mb-2">
                                        <i class="fas fa-location-dot text-warning me-3 mt-1" style="width: 20px;"></i>
            ...
            <%@ include file="/views/partials/footer.jsp" %>
                ...
                <script>
                    document.addEventListener('DOMContentLoaded', function () {
                        var stationDetailModal = document.getElementById('stationDetailModal');
                        if (stationDetailModal) {
                            stationDetailModal.addEventListener('show.bs.modal', function (event) {
                                var button = event.relatedTarget;
                                document.getElementById('detailStationId').textContent = button.getAttribute('data-stationid');
                                document.getElementById('detailStationName').textContent = button.getAttribute('data-stationname');
                                document.getElementById('detailCity').textContent = button.getAttribute('data-city');
                                document.getElementById('detailAddress').textContent = button.getAttribute('data-address');
                ...
                <script>
                    function confirmDelete(stationId, el) {
                        ...
                        document.getElementById('confirmDeleteBtn').href =
                            '${pageContext.request.contextPath}/admin/stations/delete?id=' + stationId;
