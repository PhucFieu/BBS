...
<style>
    ...
    .driver-navbar .navbar-brand:hover {
        color: rgba(255, 255, 255, 0.9) !important;
    }

    .driver-navbar .nav-link {
        color: rgba(255, 255, 255, 0.9) !important;
        font-weight: 500;
    ...
    .driver-navbar .nav-link:hover {
        color: white !important;
        background: rgba(255, 255, 255, 0.15);
        transform: translateY(-1px);
    }

    .driver-navbar .nav-link.active {
        color: white !important;
    ...
    .driver-navbar .dropdown-item {
        padding: 0.6rem 1.25rem;
        color: #333;
        transition: all 0.2s ease;
    }

    .driver-navbar .dropdown-item:hover {
        background: linear-gradient(135deg, #e8f8f0 0%, #f5f5f5 100%);
        color: #27ae60;
    }

    .driver-navbar .dropdown-item i {
        width: 20px;
    }

    .driver-navbar .navbar-toggler {
        border-color: rgba(255, 255, 255, 0.5);
    }

    .driver-navbar .navbar-toggler-icon {
        background-image: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 30 30'%3e%3cpath stroke='rgba%28255, 255, 255, 0.9%29' stroke-linecap='round' stroke-miterlimit='10' stroke-width='2' d='M4 7h22M4 15h22M4 23h22'/%3e%3c/svg%3e");
    }

    @media (max-width: 991.98px) {
        .driver-navbar .navbar-nav {
            padding-top: 0.5rem;
        }
...
<nav class="navbar navbar-expand-lg driver-navbar">
    <div class="container">
        <a class="navbar-brand" href="${pageContext.request.contextPath}/driver/trips">
            <i class="fas fa-bus me-2"></i>Driver Panel
        </a>
        ...
        <div class="collapse navbar-collapse" id="driverNavbar">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link ${requestScope['javax.servlet.forward.servlet_path'] == '/driver/trips' ? 'active' : ''}" 
                       href="${pageContext.request.contextPath}/driver/trips">
                        <i class="fas fa-route me-1"></i>My Trips
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link ${requestScope['javax.servlet.forward.servlet_path'] == '/driver/schedule' ? 'active' : ''}" 
                       href="${pageContext.request.contextPath}/driver/schedule">
            ...
            <ul class="navbar-nav">
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="driverDropdown" role="button"
                        ...
                        <span class="driver-badge ms-2">DRIVER</span>
                    </a>
